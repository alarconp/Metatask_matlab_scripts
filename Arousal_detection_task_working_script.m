...
numConditions = 3;                                     % Set the number of conditions (1: negative, 2: neutral, 3: positive)
...
participant_trial_sequence = [ones(1,(numTrials/numConditions)) ones(1,(numTrials/numConditions))*2 ones(1,(numTrials/numConditions))*3];  % Set an array of equal numbers of trial types
done = false;
cycles = 0;
maximum_consecutive_trials_per_condition = 3;
...
cycles
    ...
    %No more than three consecutive same-valence pictures
    %No more than three consecutive same-arousal pictures
...
%     imageNameB = 'EM0132.jpg';
 ...
 % Get the image files for the experiment
    imageFolderN = [cd filesep 'images' filesep 'negative'];
...
%     imageNameB = 'EM0390.jpg';
    ...
    % Now load the images
    theImageN1 = imread([imageFolderN filesep 'EM0348.jpg']);
    theImageN2 = imread([imageFolderN filesep 'EM0390.jpg']);
