...
function [position, RT, answer] = slideScale(screenPointer, question, rect, anchors, scalaLength, varargin)
...
tickPositions = linspace(rect(3)*(1-scalaLength), rect(3)*scalaLength, 9);
...
tick_1 = [tickPositions(1) center_line(2) - lineLength tickPositions(1) center_line(2) + lineLength];
tick_2 = [tickPositions(2) center_line(2) - lineLength tickPositions(2) center_line(2) + lineLength];
tick_3 = [tickPositions(3) center_line(2) - lineLength tickPositions(3) center_line(2) + lineLength];
tick_4 = [tickPositions(4) center_line(2) - lineLength tickPositions(4) center_line(2) + lineLength];
tick_5 = [tickPositions(5) center_line(2) - lineLength tickPositions(5) center_line(2) + lineLength];
tick_6 = [tickPositions(6) center_line(2) - lineLength tickPositions(6) center_line(2) + lineLength];
tick_7 = [tickPositions(7) center_line(2) - lineLength tickPositions(7) center_line(2) + lineLength];
tick_8 = [tickPositions(8) center_line(2) - lineLength tickPositions(8) center_line(2) + lineLength];
tick_9 = [tickPositions(9) center_line(2) - lineLength tickPositions(9) center_line(2) + lineLength];
...
%             [x,~,buttons,~,~,~] = GetMouse(screenPointer, 1);
%         elseif ~any(buttons) % wait for press
%             [x,~,buttons,~,~,~] = GetMouse(screenPointer, 1);
%         elseif any(buttons) % wait for release
%             [x,~,buttons,~,~,~] = GetMouse(screenPointer, 1);
%         end
...
%         end
    ...
    DrawFormattedText(screenPointer, question, 'center', rect(4)*(scalaPosition - 0.3)); 
    ...
    if length(anchors) == 2
        ...
        DrawFormattedText(screenPointer, anchors{1}, tick_1(1, 1) - textBounds(1, 3)/2,  rect(4)*scalaPosition+40, [],[],[],[],[],[],[]); % Left point
        DrawFormattedText(screenPointer, anchors{2}, tick_2(1, 1) - textBounds(1, 3)/2,  rect(4)*scalaPosition+40, [],[],[],[],[],[],[]); % Left point
        DrawFormattedText(screenPointer, anchors{3}, tick_3(1, 1) - textBounds(1, 3)/2,  rect(4)*scalaPosition+40, [],[],[],[],[],[],[]); % Left point
        DrawFormattedText(screenPointer, anchors{4}, tick_4(1, 1) - textBounds(1, 3)/2,  rect(4)*scalaPosition+40, [],[],[],[],[],[],[]); % Left point
        DrawFormattedText(screenPointer, anchors{5}, tick_5(1, 1) - textBounds(1, 3)/2,  rect(4)*scalaPosition+40, [],[],[],[],[],[],[]); % Middle point
        DrawFormattedText(screenPointer, anchors{6}, tick_6(1, 1) - textBounds(1, 3)/2,  rect(4)*scalaPosition+40, [],[],[],[],[],[],[]); % Middle point
        DrawFormattedText(screenPointer, anchors{7}, tick_7(1, 1) - textBounds(2, 3)/2,  rect(4)*scalaPosition+40, [],[],[],[],[],[],[]); % Right point
        DrawFormattedText(screenPointer, anchors{8}, tick_8(1, 1) - textBounds(2, 3)/2,  rect(4)*scalaPosition+40, [],[],[],[],[],[],[]); % Right point
        DrawFormattedText(screenPointer, anchors{9}, tick_9(1, 1) - textBounds(2, 3)/2,  rect(4)*scalaPosition+40, [],[],[],[],[],[],[]); % Right point
...
%% Waiting that all keys are released and delete texture
