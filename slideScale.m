...
leftTick_0   = [rect(3)*(1-scalaLength) rect(4)*scalaPosition - lineLength rect(3)*(1-scalaLength) rect(4)*scalaPosition  + lineLength];
leftTick_1 = [rect(3)*(scalaLength/10) rect(4)*scalaPosition - lineLength rect(3)*(scalaLength/10) rect(4)*scalaPosition  + lineLength];
leftTick_2 = [rect(3)*(scalaLength/10)*2 rect(4)*scalaPosition - lineLength rect(3)*(scalaLength/10)*2 rect(4)*scalaPosition  + lineLength];
leftTick_3 = [rect(3)*(scalaLength/10)*3 rect(4)*scalaPosition - lineLength rect(3)*(scalaLength/10)*3 rect(4)*scalaPosition  + lineLength];
leftTick_4 = [rect(3)*(scalaLength/10)*4 rect(4)*scalaPosition - lineLength rect(3)*(scalaLength/10)*4 rect(4)*scalaPosition  + lineLength];
midTick_5  = [center(1) rect(4)*scalaPosition - lineLength  center(1) rect(4)*scalaPosition  + lineLength];
rightTick_6  = [rect(3)*(scalaLength/10)*6 rect(4)*scalaPosition - lineLength rect(3)*(scalaLength/10)*6 rect(4)*scalaPosition  + lineLength];
rightTick_7  = [rect(3)*(scalaLength/10)*7 rect(4)*scalaPosition - lineLength rect(3)*(scalaLength/10)*7 rect(4)*scalaPosition  + lineLength];
rightTick_8  = [rect(3)*(scalaLength/10)*8 rect(4)*scalaPosition - lineLength rect(3)*(scalaLength/10)*8 rect(4)*scalaPosition  + lineLength];
rightTick_9  = [rect(3)*(scalaLength/10)*9 rect(4)*scalaPosition - lineLength rect(3)*(scalaLength/10)*9 rect(4)*scalaPosition  + lineLength];
rightTick_10  = [rect(3)*scalaLength rect(4)*scalaPosition - lineLength rect(3)*scalaLength rect(4)*scalaPosition  + lineLength];
...
while answer == 0
    ...
    if length(anchors) == 2
        ...
        DrawFormattedText(screenPointer, anchors{1}, leftTick_0(1, 1) - textBounds(1, 3)/2,  rect(4)*scalaPosition+40, [],[],[],[],[],[],[]); % Left point
        DrawFormattedText(screenPointer, anchors{2}, leftTick_1(1, 1) - textBounds(1, 3)/2,  rect(4)*scalaPosition+40, [],[],[],[],[],[],[]); % Left point
        DrawFormattedText(screenPointer, anchors{3}, leftTick_2(1, 1) - textBounds(1, 3)/2,  rect(4)*scalaPosition+40, [],[],[],[],[],[],[]); % Left point
        DrawFormattedText(screenPointer, anchors{4}, leftTick_3(1, 1) - textBounds(1, 3)/2,  rect(4)*scalaPosition+40, [],[],[],[],[],[],[]); % Left point
        DrawFormattedText(screenPointer, anchors{5}, leftTick_4(1, 1) - textBounds(1, 3)/2,  rect(4)*scalaPosition+40, [],[],[],[],[],[],[]); % Left point
        DrawFormattedText(screenPointer, anchors{6}, 'center',  rect(4)*scalaPosition+40, [],[],[],[],[],[],[]); % Middle point
        DrawFormattedText(screenPointer, anchors{7}, rightTick_6(1, 1) - textBounds(2, 3)/2,  rect(4)*scalaPosition+40, [],[],[],[],[],[],[]); % Right point
        DrawFormattedText(screenPointer, anchors{8}, rightTick_7(1, 1) - textBounds(2, 3)/2,  rect(4)*scalaPosition+40, [],[],[],[],[],[],[]); % Right point
        DrawFormattedText(screenPointer, anchors{9}, rightTick_8(1, 1) - textBounds(2, 3)/2,  rect(4)*scalaPosition+40, [],[],[],[],[],[],[]); % Right point
        DrawFormattedText(screenPointer, anchors{10}, rightTick_9(1, 1) - textBounds(2, 3)/2,  rect(4)*scalaPosition+40, [],[],[],[],[],[],[]); % Right point
        DrawFormattedText(screenPointer, anchors{11}, rightTick_10(1, 1) - textBounds(2, 3)/2,  rect(4)*scalaPosition+40, [],[],[],[],[],[],[]); % Right point

    end
    
    % Drawing the scale
    Screen('DrawLine', screenPointer, scaleColor, leftTick_0(1), leftTick_0(2), leftTick_0(3), leftTick_0(4), width); % 0 tick
    Screen('DrawLine', screenPointer, scaleColor, leftTick_1(1), leftTick_1(2), leftTick_1(3), leftTick_1(4), width); % 1 tick
    Screen('DrawLine', screenPointer, scaleColor, leftTick_2(1), leftTick_2(2), leftTick_2(3), leftTick_2(4), width); % 2 tick
    Screen('DrawLine', screenPointer, scaleColor, leftTick_3(1), leftTick_3(2), leftTick_3(3), leftTick_3(4), width); % 3 tick
    Screen('DrawLine', screenPointer, scaleColor, leftTick_4(1), leftTick_4(2), leftTick_4(3), leftTick_4(4), width); % 4 tick
    Screen('DrawLine', screenPointer, scaleColor, midTick_5(1), midTick_5(2), midTick_5(3), midTick_5(4), width); % 5 tick
    Screen('DrawLine', screenPointer, scaleColor, rightTick_6(1), rightTick_6(2), rightTick_6(3), rightTick_6(4), width); % 6 tick
    Screen('DrawLine', screenPointer, scaleColor, rightTick_7(1), rightTick_7(2), rightTick_7(3), rightTick_7(4), width); % 7 tick
    Screen('DrawLine', screenPointer, scaleColor, rightTick_8(1), rightTick_8(2), rightTick_8(3), rightTick_8(4), width); % 8 tick
    Screen('DrawLine', screenPointer, scaleColor, rightTick_9(1), rightTick_9(2), rightTick_9(3), rightTick_9(4), width); % 9 tick
    Screen('DrawLine', screenPointer, scaleColor, rightTick_10(1), rightTick_10(2), rightTick_10(3), rightTick_10(4), width); % 10 tick
